...
//shape - connecting two points with a staright line
class Line{
...
//shape - collection of points with the same distance from a center
class Circle{
    constructor(x, y, r){
        this.vertex = [];
...
//shape - two parallel line segments forming a polygon with four right angles
class Rectangle{
...
function mainLoop(timestamp) {
    ...
    for(let o1comp=0; o1comp<testCaps.comp.length; o1comp++){
        for(let o2comp=0; o2comp<testCaps.comp.length; o2comp++){
            if(sat(testCaps.comp[o1comp], Caps1.comp[o2comp]).pen > bestSat.pen){
                bestSat = sat(testCaps.comp[o1comp], Caps1.comp[o2comp]);
...
let testCaps = new Capsule(200, 100, 100, 200, 50, 3);
//let testBall = new Ball(200, 200, 80, 6);
//let Box2 = new Box(300, 180, 250, 50, 80, 5);
//let Ball1 = new Ball(300, 100, 50, 5);
//let Wall1 = new Wall(300, 100, 250, 400);
let Caps1 = new Capsule(350, 100, 300, 400, 60, 3);
